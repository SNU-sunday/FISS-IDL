directories=['/data/home/chokh/2017_fiss/2017/09']
;directories=['D:\fiss_process\02', $
;             'D:\fiss_process\03', $
;             'D:\fiss_process\04']
...
if get_flat_pattern then begin
  for idet=idet1, idet2 do begin
    ...
    for k=0, nflat-1 do begin
      ...
      fiss_get_flat,  fflats[k], fdarks[k<(ndark-1)],  flat_file, tilt, slit_pattern=slit_pattern
...
if data_process then begin
  ...
  for reg=0,  ( nreg-1)  do begin
    ...
    for idet=idet1,  idet2 do begin
      ...
      slitfiles=fiss_calfile(datafiles, proc_cal_dir, type='slit', det=detector)
...
;      stop
      ...
      for k=0, (nf-1) do  begin
        ...
        if calfiles[k] ne calfile then begin
          calfile=calfiles[k]
          fiss_cal_par, calfile, (fiss_calfile(calfile, proc_cal_dir, typ='flat', det=detector))[0], $
                        '', slit_pattern,  tilt, dw
        endif
        fiss_prep, datafiles[k], proc_files[k], flatfiles[k], darkfiles[k], slit_pattern, $
